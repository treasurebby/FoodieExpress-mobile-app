...
import { RiderSignupCredentials } from '@/types';
...
export default function RiderSignupScreen() {
  ...
  const [formData, setFormData] = useState<RiderSignupCredentials>({
    name: '',
    email: '',
    password: '',
    confirmPassword: '',
  ...
  const handleInputChange = (field: keyof RiderSignupCredentials, value: string) => {
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      // Navigate to rider onboarding after signup
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Become a Rider</Text>
      </View>
      ...
      <View style={styles.form}>
        ...
        {/* Vehicle Type */}
        <View style={styles.formGroup}>
          <Text style={styles.label}>Vehicle Type <Text style={styles.optional}>(Optional)</Text></Text>
          <TextInput
            style={styles.input}
        ...
        <View style={styles.formGroup}>
          <Text style={styles.label}>Vehicle Registration <Text style={styles.optional}>(Optional)</Text></Text>
          <TextInput
            style={styles.input}
        ...
        {/* Driver License */}
        <View style={styles.formGroup}>
          <Text style={styles.label}>Driver License <Text style={styles.optional}>(Optional)</Text></Text>
          <TextInput
            style={styles.input}
        ...
        {/* Bank Details */}
        <View style={styles.formGroup}>
          <Text style={styles.label}>Bank Details <Text style={styles.optional}>(Optional)</Text></Text>
          <TextInput
            style={styles.input}
